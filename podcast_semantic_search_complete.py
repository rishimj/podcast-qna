...
class PodcastTwoTierSearch:
    def __init__(self, db_path="podcast_index_v2.db", embedding_model="nomic-embed-text:latest"):
    ...
    def migrate_from_v1(self, old_db_path="podcast_index.db"):
...
def upgrade_existing_database():
    ...
    if os.path.exists("podcast_index.db"):
